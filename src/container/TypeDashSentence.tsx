...
import {getCloudSentence} from '../components/Cloud';

export default function TypeDashSentence(): JSX.Element {
    const [userInput, setUserInput] = useState<string>('');
    const cloud = useRef<any>(getCloudSentence());
    ...
    function resetTest(): void {
        ...
        setCorrectWordArray([]);
        cloud.current = getCloudSentence();
        setTimeElapsed(0);
