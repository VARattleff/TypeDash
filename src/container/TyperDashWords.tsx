...
import { getCloudWord} from '../components/Cloud';

export default function TyperDashWords(): JSX.Element {
    const [userInput, setUserInput] = useState<string>('');
    const cloud = useRef<any>(getCloudWord());
